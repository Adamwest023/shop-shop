...
//create a test to handle adding to the cart
test('ADD_TO_CART', () => {
    let newState = reducer(initialState, {
        type: ADD_TO_CART,
...
//create a test to handle adding multiple items to the cart
...
//create a test to handle removing items from the cart
...
// test to handle cart's visibility 
test('TOGGLE_CART', () => {
    let newState = reducer(initialState, {
      type: TOGGLE_CART
    });
